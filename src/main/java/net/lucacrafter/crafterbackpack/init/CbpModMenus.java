...
public class CbpModMenus {
    ...
    public static final RegistryObject<MenuType<ContainerScreenMenu>> CONTAINER_SCREEN = REGISTRY.register("container", () -> IForgeMenuType.create(ContainerScreenMenu::new));
}
