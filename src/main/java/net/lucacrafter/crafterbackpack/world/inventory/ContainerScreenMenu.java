...
public class ContainerScreenMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
    ...
    public ContainerScreenMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
        super(CbpModMenus.CONTAINER_SCREEN.get(), id);
